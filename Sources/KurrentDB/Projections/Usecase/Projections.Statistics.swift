...
public struct ProjectionDetail: Sendable {
...
extension Projections.Statistics {
    /// `Detail` is a typealias for `ProjectionDetail`, allowing all target specialisations
    /// of `Projections<T>.Statistics.Detail` to resolve to the same concrete type.
    public typealias Detail = ProjectionDetail
}
