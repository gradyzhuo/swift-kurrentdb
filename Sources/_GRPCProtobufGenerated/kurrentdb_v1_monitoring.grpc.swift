...
/// Namespace containing _GRPCProtobufGenerated types for the "event_store.client.monitoring.Monitoring" service.
...
extension EventStore_Client_Monitoring_Monitoring {
    /// _GRPCProtobufGenerated client protocol for the "event_store.client.monitoring.Monitoring" service.
    ///
    ...
    /// _GRPCProtobufGenerated client for the "event_store.client.monitoring.Monitoring" service.
    ///
