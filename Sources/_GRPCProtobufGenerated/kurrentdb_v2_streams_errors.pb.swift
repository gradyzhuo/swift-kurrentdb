...
package enum Kurrentdb_Protocol_V2_Streams_Errors_StreamsError: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  case appendConsistencyViolation // = 14
  ...
  package init?(rawValue: Int) {
    ...
    case 14: self = .appendConsistencyViolation
  ...
  package var rawValue: Int {
    ...
    case .appendConsistencyViolation: return 14
...
package struct Kurrentdb_Protocol_V2_Streams_Errors_AppendConsistencyViolationErrorDetails: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The consistency checks that were violated.
  package var violations: [Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation] = []
...
package struct Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Index of the check in the original consistency_checks list.
  package var checkIndex: Int32 = 0

  package var type: Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.OneOf_Type? = nil

  /// The stream was not at the expected state.
  package var streamState: Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.StreamStateViolation {
    get {
      if case .streamState(let v)? = type {return v}
      return Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.StreamStateViolation()
    }
  ...
  package enum OneOf_Type: Equatable, Sendable {
    /// The stream was not at the expected state.
    case streamState(Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.StreamStateViolation)

  }

  /// A stream state check was violated because the actual state did not match the expected state.
  package struct StreamStateViolation: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var actualState: Int64 = 0
...
extension Kurrentdb_Protocol_V2_Streams_Errors_AppendConsistencyViolationErrorDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".AppendConsistencyViolationErrorDetails"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}violations\0")
  ...
  package static func ==(lhs: Kurrentdb_Protocol_V2_Streams_Errors_AppendConsistencyViolationErrorDetails, rhs: Kurrentdb_Protocol_V2_Streams_Errors_AppendConsistencyViolationErrorDetails) -> Bool {
...
extension Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ConsistencyViolation"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}check_index\0\u{3}stream_state\0")
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.checkIndex) }()
      case 2: try {
        var v: Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.StreamStateViolation?
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.checkIndex != 0 {
      try visitor.visitSingularInt32Field(value: self.checkIndex, fieldNumber: 1)
    }
  ...
  package static func ==(lhs: Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation, rhs: Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation) -> Bool {
    if lhs.checkIndex != rhs.checkIndex {return false}
...
extension Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.StreamStateViolation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.protoMessageName + ".StreamStateViolation"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}stream\0\u{3}expected_state\0\u{3}actual_state\0")
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularSInt64Field(value: &self.actualState) }()
      default: break
      }
    }
  }
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.actualState != 0 {
      try visitor.visitSingularSInt64Field(value: self.actualState, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  package static func ==(lhs: Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.StreamStateViolation, rhs: Kurrentdb_Protocol_V2_Streams_Errors_ConsistencyViolation.StreamStateViolation) -> Bool {
    if lhs.stream != rhs.stream {return false}
    if lhs.expectedState != rhs.expectedState {return false}
    if lhs.actualState != rhs.actualState {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
