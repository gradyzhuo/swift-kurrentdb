...
/// Namespace containing _GRPCProtobufGenerated types for the "event_store.cluster.Gossip" service.
...
extension EventStore_Cluster_Gossip {
    /// _GRPCProtobufGenerated client protocol for the "event_store.cluster.Gossip" service.
    ///
    ...
    /// _GRPCProtobufGenerated client for the "event_store.cluster.Gossip" service.
    ///
...
/// Namespace containing _GRPCProtobufGenerated types for the "event_store.cluster.Elections" service.
@available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
...
extension EventStore_Cluster_Elections {
    /// _GRPCProtobufGenerated client protocol for the "event_store.cluster.Elections" service.
    ///
    /// You don't need to implement this protocol directly, use the _GRPCProtobufGenerated
    /// implementation, ``Client``.
    package protocol ClientProtocol: Sendable {
    ...
    /// _GRPCProtobufGenerated client for the "event_store.cluster.Elections" service.
    ///
    /// The ``Client`` provides an implementation of ``ClientProtocol`` which wraps
    /// a `GRPCCore.GRPCCClient`. The underlying `GRPCClient` provides the long-lived
    /// means of communication with the remote peer.
