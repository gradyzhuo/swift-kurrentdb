...
/// Namespace containing _GRPCProtobufGenerated types for the "event_store.client.gossip.Gossip" service.
...
extension EventStore_Client_Gossip_Gossip {
    /// _GRPCProtobufGenerated client protocol for the "event_store.client.gossip.Gossip" service.
    ///
    ...
    /// _GRPCProtobufGenerated client for the "event_store.client.gossip.Gossip" service.
    ///
