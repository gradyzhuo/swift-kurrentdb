...
let package = Package(
    ...
    targets: [
        ...
        // Needs a licensed KurrentDB node started by server/x509/start.sh;
        // skipped unless KURRENTDB_X509_CERTS_DIR is set.
        .testTarget(
            name: "X509Tests",
            dependencies: [
                "KurrentDB",
        ...
        // Compiles the Swift examples from the documentation. The snippets file is
        // generated by `scripts/generate-doc-snippets.py` and never runs.
        .testTarget(
            name: "DocSnippetsTests",
            dependencies: [
                "KurrentDB",
                "KurrentDBPool",
            ],
            swiftSettings: [
                // Examples routinely leave values unused; only errors matter here.
